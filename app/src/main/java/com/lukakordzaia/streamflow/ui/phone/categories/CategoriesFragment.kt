...
import com.lukakordzaia.streamflow.databinding.FragmentPhoneCategoriesBinding
...
class CategoriesFragment : BaseFragment<FragmentPhoneCategoriesBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentPhoneCategoriesBinding
        get() = FragmentPhoneCategoriesBinding::inflate
